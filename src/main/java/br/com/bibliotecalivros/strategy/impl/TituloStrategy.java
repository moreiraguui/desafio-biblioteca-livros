...
import static br.com.bibliotecalivros.utils.Constants.BUSCA_POR_TITULO;

@Component
public class TituloStrategy implements BuscaLivroStrategy {
    ...
    public Page<Livro> buscar(LivroRepository livroRepository, String titulo, String autor, Integer anoPublicacao, Pageable pageable) {
        return livroRepository.findAllByTitulo(titulo, pageable);
    }

    @Override
    public String keyBuscaLivro() {
        return BUSCA_POR_TITULO;
    }
}